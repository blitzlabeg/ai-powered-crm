...
```
 ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” 
 ” Browser (User) ” 
 ” HTML pages (Jinja2) + small vanilla JS (dark mode, AI, ” 
 ...
 ” ” (HTML pages ” ” ” – ” (Pydantic ” ” - AI service ” ” 
 ” ” + JSON API) ” ” validation) ” ” (OpenAI Responses) ” ” 
 ” ”” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ”” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” - CRUD helpers ” ” 
 ” ” ”” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” 
 ” – ” ” 
 ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” – ” ” ” ” ” ” ” ” ” ” ” ” 
...
1. **HTML page routes** (`GET /companies`, `GET /companies/{id}`, `POST
 /companies/new`, ) that render Jinja2 templates and handle HTML form
 submissions.
...
```
Company 1 ” ” ” * Contact 1 ” ” ” 1 Customer
 ” ” ” 
 ” ”” ” ” ” * Lead ” 
 ” ” 
 ”” ” ” ” ” ” ” ” ” ” ” ” ” ” ” ” * Deal ” ” ” ” ” ” ” ” 
 ” 
 Task / Note / Meeting ” ” (generic related_type + related_id) ” ” – any entity
```

- **Company** ” an organization.
- **Contact** ” a person, optionally linked to a `Company`.
- **Customer** ” a converted account; optionally linked to a `Contact` and/or
 `Company`. Tracks `status` and `lifetime_value`.
- **Lead** ” a sales opportunity not yet converted; has `status`, `source`,
 `score`, and an `ai_summary` field populated by the AI summarization feature.
- **Deal** ” an opportunity actively moving through the sales pipeline
 (`stage`, `value`, `probability`); has an `ai_recommendation` field.
- **Task** ” a to-do item. Uses a **generic polymorphic relationship**
 (`related_type` + `related_id`) so a task can point at *any* other entity
 without needing a foreign key column per entity type.
- **Note** ” freeform text, same generic relationship pattern as `Task`.
- **Meeting** ” scheduled event with an `ai_summary` field.
...
type (`company_id`, `contact_id`, `lead_id`, `deal_id`, ) would work, but it
...
foreign key constraint) for flexibility ” new entity types don't require
...
code differs between the two ” this is the benefit of using SQLAlchemy's ORM
...
- `app/static/css/style.css` ” a single stylesheet using CSS custom
 properties for theming (light/dark mode switches by swapping variable
 values on `<html data-theme="...">`).
- `app/static/js/app.js` ” dark mode toggle, mobile sidebar toggle, delete
 confirmations, and Kanban drag-and-drop.
- `app/static/js/ai.js` ” `fetch()`-based handlers for the AI panels that
